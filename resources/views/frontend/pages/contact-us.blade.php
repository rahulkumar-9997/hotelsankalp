...
@section('main-content')
    <section class="breadcrumb-area d-flex align-items-center" style="background-image:url('{{asset('fronted/hotelsankalp-img/breadcrub/bread-4.jpg') }}')">
        <div class="container">
                ...
                <div class="col-lg-4 order-1 d-flex justify-content-between">
                    ...
                    <div class="single-cta pb-30 mb-30 wow fadeInUp animated" data-animation="fadeInDown animated" data-delay=".2s">
                        ...
                        <div class="contact-div">
                            <h5>Mobile </h5>
                            <p>
                                <a href="tel:+919415285030">+91-9415285030</a>
                                <br> 
                                <a href="tel:+919208464648">+91-9208464648</a>
                            </p>
                        </div>
                    </div>
