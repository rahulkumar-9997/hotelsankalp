            ...
            <div class="page-title">
                ...
                <div class="pull-right hidden-xs">
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="{{route('hotel-facilities')}}"><i class="fa fa-home"></i>Manage Hotel Facilities</a>
                        </li>

                        <li class="active">
                            <strong>Edit Hotel Facilities</strong>
                        </li>
                    </ol>
                </div>
            </div>
        ...
        <div class="col-lg-12">
            <section class="box ">
                <header class="panel_header">
                    <h2 class="title pull-left">Edit Hotel Facilities</h2>
                </header>
                <div class="content-body">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <form action="{{ route('hotel-facilities.update') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" value="{{ $facilities_edit->id }}" name="facilities_id">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="form-label">Facilities Name</label>
                                            <div class="controls">
                                                <input type="text" class="form-control" name="facilities_name" value="{{ $facilities_edit->title }}">
                                            </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="banner-img">
                                                <img  src="{{ asset('hotel-sankalp-image-file/facilities-icon/' . $facilities_edit->facilities_icon) }}" class="img-responsive" style="width: 200px;">
                                            </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                            <textarea class="" placeholder="Facilities content ..." style="width: 100%; height: 200px; font-size: 14px; line-height: 23px;padding:15px;" name="facilities_content"> {{ $facilities_edit->facilities_content }}</textarea>
                                            </div>
