        ...
        <div class="col-lg-12">
            <section class="box ">
                <header class="panel_header">
                    <h2 class="title pull-left">Add Banner</h2>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="form-control" name="banner_url_link">
                                            </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                            <textarea class="" placeholder="Banner content ..." style="width: 100%; height: 200px; font-size: 14px; line-height: 23px;padding:15px;" name="banner_content"></textarea>
                                            </div>
