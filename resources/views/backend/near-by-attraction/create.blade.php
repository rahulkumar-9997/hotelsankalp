            ...
            <div class="content-body">
               <div class="row">
                  <div class="col-md-12 col-sm-12 col-xs-12">
                     <form action="{{ route('near-by-attractions.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                           <div class="col-lg-6">
                           ...
                           <div class="col-lg-12">
                              <div class="form-group">
                                 ...
                                 <div class="controls">
                                    <textarea class="bootstrap-wysihtml5-textarea" placeholder="Room description ..." style="width: 100%; height: 200px; font-size: 14px; line-height: 23px;padding:15px;" name="description"></textarea>
                                 </div>
