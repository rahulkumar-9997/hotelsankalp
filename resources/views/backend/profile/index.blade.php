                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="email" class="form-control" name="profile_email" value="{{$user->email}}">
                                            </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="form-control" name="mobile_number" maxlength="10" value="{{$user->phone_number}}">
                                            </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                ...
                                                <br><img src="{{ asset('hotel-sankalp-image-file/profile-img/' . $user->profile_img) }}" style="width: 100px;">
                                            </div>
