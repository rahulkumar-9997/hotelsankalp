<div class='page-topbar '>
            <div class='logo-area'>
                <img src="{{asset('backend/assets/hotelsankalp/transparent-logo.png')}}" class="webadmin-logo">
            </div>
            <div class='quick-area'>
                ...
                <div class='pull-right'>
                    <ul class="info-menu right-links list-inline list-unstyled author_name">
                        <li class="profile">
